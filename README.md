...
* **Attack Mechanics:** Deep understanding of Living-off-the-Land Binaries (LOLBins) and APT vector analysis.
* **Reporting:** Adherence to professional A.D.R. (Attack, Detection, Response) reporting standards.

## 🤝 Unit Convergence
This repository is the "Spear" (Attack/Log Specialist) half of a symbiotic SOC unit. The corresponding "Shield" (Detection Engineering/SIEM) rules are maintained in a parallel operational repository by my engineering counterpart.
